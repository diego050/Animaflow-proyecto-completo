...
from app.modules.ae_export.zip_exporter import create_export_zip  # legacy (módulo archivado)
        ...
        try:
            ...
            for i, scene in enumerate(scenes):
                ...
                if scene.get('type') == 'custom' and scene.get('anima_composer'):
                    ...
                    try:
                        from app._legacy_orchestrator.anima_composer.ae_transformer import anima_composer_to_aescript
