...
export function AdminDashboardPage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      sub: `${stats.pending_jobs} pendientes`,
      icon: Briefcase,
    ...
    },
    {
      ...
      sub: `${stats.success_rate.toFixed(1)}% éxito`,
      icon: CheckCircle,
    ...
    },
    {
      ...
      sub: `${stats.rendering_jobs} renderizando`,
      icon: XCircle,
      color: 'text-red-400',
      bg: 'bg-red-500/10',
    },
    {
      ...
      value: `${stats.total_storage_mb.toFixed(0)} MB`,
      sub: `Prom: ${stats.avg_render_time_seconds.toFixed(0)}s render`,
      icon: HardDrive,
