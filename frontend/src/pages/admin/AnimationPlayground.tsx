...
const STYLE_SYSTEM_EXAMPLES = [
  ...
  {
    id: 'full-composition',
    name: 'Full Composition (All Components)',
    icon: '🎬',
    spec: {
      version: '1.0',
      background: { type: 'radial-gradient', colors: ['#0a1628', '#0f172a'], angle: 0 },
      layers: [
        ...
        },
        {
          ...
          subtitle: 'Datos actualizados en tiempo real',
          variant: 'elevated',
          x: 540,
          y: 800,
          width: 380,
        ...
        },
        {
          ...
          gap: 8,
          children: [
            { type: 'component', componentName: 'StyleChip', text: 'React', variant: 'filled', size: 'sm', entry: 'fade-in', entryDelay: 1.5 },
            { type: 'component', componentName: 'StyleChip', text: 'Python', variant: 'filled', size: 'sm', entry: 'fade-in', entryDelay: 1.6 },
            { type: 'component', componentName: 'StyleChip', text: 'AI', variant: 'filled', size: 'sm', entry: 'fade-in', entryDelay: 1.7 },
          ],
        },
      ],
    },
