...
export const COMPONENT_MANIFEST: ComponentManifestEntry[] = [
  ...
  // ========================================================================
  {
    ...
    category: 'Cinematic',
    role: 'decorative',
    description: 'A single configurable geometric shape (circle, square, triangle, polygon, star, ring) centered at x,y. Great as an accent behind text using zIndex.',
    props: [
      { name: 'shape', type: 'select', label: 'Shape', description: 'Shape kind', defaultValue: 'circle', options: ['circle', 'square', 'triangle', 'pentagon', 'hexagon', 'star', 'ring'] },
      { name: 'size', type: 'number', label: 'Size', description: 'Shape size (px)', defaultValue: 240, min: 40, max: 1000 },
      ...
      { name: 'strokeColor', type: 'color', label: 'Stroke Color', description: 'Outline color (when not filled / ring)', defaultValue: '#6366f1' },
      { name: 'strokeWidth', type: 'number', label: 'Stroke Width', description: 'Outline thickness (px)', defaultValue: 8, min: 1, max: 40 },
      { name: 'cornerRadius', type: 'number', label: 'Corner Radius', description: 'Rounded corners (square only)', defaultValue: 24, min: 0, max: 200 },
  ...
  },
  {
    ...
    category: 'Cinematic',
    role: 'decorative',
    description: 'Expanding concentric ripples from a center dot. (Merged into RippleEffect — prefer RippleEffect with centerDot for new scenes.)',
    props: [
      { name: 'color', type: 'color', label: 'Color', description: 'Ring & dot color', defaultValue: '#f43f5e' },
      ...
      { name: 'centerDotSize', type: 'number', label: 'Center Dot', description: 'Center dot size (px)', defaultValue: 40, min: 0, max: 120 },
      { name: 'baseSize', type: 'number', label: 'Base Size', description: 'Base ring diameter (px)', defaultValue: 200, min: 50, max: 600 },
  ...
  },
  {
    ...
    props: [
      ...
      { name: 'clickFrame', type: 'number', label: 'Click Frame', description: 'Frame when the click happens', defaultValue: 35, min: 0, max: 300 },
  ...
  },
  {
    ...
    props: [
      ...
      { name: 'mergeColor', type: 'color', label: 'Merge Color', description: 'Merge commit color', defaultValue: '#f59e0b' },
