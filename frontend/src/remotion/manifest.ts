...
export const COMPONENT_MANIFEST: ComponentManifestEntry[] = [
  ...
  },
  {
    ...
    category: 'Cinematic',
    role: 'decorative',
    description: 'Animated cursor that moves to a target and clicks with ripple effect. For multi-click/multi-move use StyleCursor (points[]).',
    props: [
      ...
      { name: 'cursorColor', type: 'color', label: 'Cursor Color', description: 'Cursor fill color', defaultValue: '#1e293b' },
      { name: 'rippleColor', type: 'color', label: 'Ripple Color', description: 'Click ripple color', defaultValue: '#38bdf8' },
      { name: 'cursorSize', type: 'number', label: 'Cursor Size', description: 'Cursor size (px)', defaultValue: 48, min: 16, max: 120 },
      { name: 'moveDuration', type: 'number', label: 'Move Duration', description: 'Frames to reach the target', defaultValue: 30, min: 5, max: 120 },
      { name: 'clickDelay', type: 'number', label: 'Click Delay', description: 'Frames AFTER arrival before clicking (click is auto-synced to the cursor)', defaultValue: 6, min: 0, max: 60 },
    ],
  },
  {
  ...
  },
  {
    ...
    category: 'Cinematic',
    role: 'decorative',
    description: 'Breaking news ticker bar with scrolling text and a configurable badge.',
    props: [
